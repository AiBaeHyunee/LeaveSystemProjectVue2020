...
<!--                            placement="bottom"-->
<!--                    >-->
<!--                        <router-link to="/system_msg/notice_msg">-->
...
<!--                </div>-->
                <el-dropdown @command="handleCommand1">
                    ...
                    <el-dropdown-menu slot="dropdown">
                        <el-dropdown-item  command="notice_msg">公告消息</el-dropdown-item>
                        <!--                                <router-link to="/tabs">-->
                        <!--                                    <i class="el-icon-bell"></i>-->
                        <!--                                </router-link>-->
                        <el-dropdown-item divided command="answer_msg">答复消息</el-dropdown-item>
    ...
    export default {
        ...
        methods: {
            ...
            handleCommand1(command) {
                if (command == 'notice_msg') {

                    this.$router.push('/system_msg/notice_msg');
                }
                if (command == 'answer_msg') {
