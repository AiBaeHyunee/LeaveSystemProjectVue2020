    ...
    <div>
        <div class="content-title-box">
            <el-breadcrumb separator-class="el-icon-arrow-right">
                <el-breadcrumb-item >后勤处</el-breadcrumb-item>
                <el-breadcrumb-item :to="{ path: '/sector/logistics/review_logistics' }">搜索公告</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
            ...
            getInfo(id) {
                teacher.getNotice(id)
                    .then(response => {
                        ...
                        this.$router.push('/sector/logistics/logistics_notice')
                    })},
