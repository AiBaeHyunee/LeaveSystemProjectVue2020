<template lang="html">
    ...
    <div class="content-title-box">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{ path: '/manager/user_manage/edit_manager' }">编辑角色</el-breadcrumb-item>
        </el-breadcrumb>
    </div>
    <el-card class="box-card">
        ...
        <div>
            <el-table
                ...
                <el-table-column label="操作权限" prop="erpMemberPermissions" :formatter="permListFormatter"></el-table-column>
            ...
            onEditSubmit() {
                this.$refs.roleForm.validate(valid => {
                    if (valid) {
                        ...
                        formData.append('code', this.roleForm.code)
