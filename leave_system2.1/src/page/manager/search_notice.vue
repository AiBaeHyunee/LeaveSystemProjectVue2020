    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-tickets"></i> 管理员功能
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                ...
                >批量删除</el-button>
                <el-select v-model="query.address" placeholder="发布部门" class="handle-select mr10">
            ...
            >
                ...
                <el-table-column prop="name" label="公告标题" align="center"></el-table-column>
                <!--                <el-table-column label="发布者">-->
                <!--                    <template slot-scope="scope">￥{{scope.row.money}}</template>-->
                <!--                </el-table-column>-->
                <el-table-column prop="user" label="发布者" width="80" align="center"></el-table-column>
                ...
                <!--                <el-table-column prop="content" label="内容" width="55" align="center"></el-table-column>-->
